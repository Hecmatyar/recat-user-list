...
// function setupFacebookId() {
//     const facebookId = getSettings().facebookAppId;
//     if (facebookId) {
//         replaceInFile(infoPlist, [
//             [/(.*)(FacebookAppID.*\n*\s*\<string>)\d*(.*)/g, `$1$2${facebookId}$3`],
//             [/<string>fb\d*<\/string>/g, `<string>fb${facebookId}</string>`]
//         ]);
//         replaceInFile(droidValuesFile, /<string name="facebook_app_id">.*<\/string>/g, `<string name="facebook_app_id">${facebookId}</string>`)
//         log("successfully write facebookId to files");
//     }
// }